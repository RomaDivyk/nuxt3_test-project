...
const data = store.dataPermissions;
const pageUrl = 'permissions/';

fetchDataPermissions(pageUrl);
...
<template>
  ...
  <v-form v-model="valid" @submit.prevent="createItem(newPermission, pageUrl)">
    <v-container>
      <v-row>
        <v-col cols="12" md="4">
          <v-text-field
    ...
    <v-container>
      <v-row align="center" justify="center">
        <v-btn class="mt-2" text="Add new permission" type="submit"></v-btn>
      </v-row>
    </v-container>
    <v-container>
      <v-row align="center" justify="center">
