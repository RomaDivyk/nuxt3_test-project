...
const response = await $fetch(`https://v2-stage.astra-company.com/api/v2/permissions/${route.params.id}`);
...
<template>
  <v-sheet class="mx-auto" max-width="300">
    ...
    <NuxtLink to="/permissions">
      <v-btn variant="tonal" class="mt-2" text="Back to permissions page" type="submit"></v-btn>
    </NuxtLink>
  </v-sheet>
</template>
